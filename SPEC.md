...
| 右カード | `.hv2-services` の5サービス: ビズマンガ(→ bizmanga.contentsx.jp) / スクール / コンテンツセールス / IP事業 / コンテンツ採用(下フル幅、→ ichioshi.contentsx.jp 2026-07-07設定)。未確定の2〜4番目は `href="#"` + `data-todo` 属性。スキューシャドウ枠 |
