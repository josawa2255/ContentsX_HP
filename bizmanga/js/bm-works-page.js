...
(function() {
  ...
  var FALLBACK_WORKS = [
    ...
    { id: 'bms-unso-remake', title_ja: 'BMS運送', pages: 10, category: '採用',
  ...
  function renderWorks(works, filterCategory) {
    ...
    filtered.forEach(function(w) {
      ...
      var coverSrc = w.thumbnail || '../material/manga/' + w.id + '/01.webp';
  ...
  function openWorkDetail(workId) {
    ...
    if (wdCarousel) {
      ...
      var firstSrc = (work.gallery && work.gallery[0]) ? work.gallery[0] : '../material/manga/' + work.id + '/01.webp';
