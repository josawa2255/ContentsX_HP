...
var thanksPageSrc = '../material/manga/thanks_v02.webp';
...
(function() {
  const preData = {
    ...
    name: [
      { key: 'pre-name-merumaga', title: 'BMS メルマガ ネーム', path: '../material/pre/name/bms-merumaga/', pages: 9 },
      { key: 'pre-name-fax', title: 'BMS FAX ネーム', path: '../material/pre/name/bmsfax/', pages: 9 },
      { key: 'pre-name-ichinohe', title: '一戸ホーム ネーム', path: '../material/pre/name/ichinohe-name/', pages: 20 }
    ]
  };
